...
document.addEventListener('DOMContentLoaded', () => {
  const config = {
    ...
    consentBanner: {
      ...
      description: [
        "We've added essential and additional cookies to ensure this service works effectively, track how it's being used,",
        'and make necessary improvements. You can manage your preferences or read our',
        '<a href="/privacy-collection-notice.html">Privacy Collection Notice</a> to learn how we handle personal',
