    ...
    palettes: {
      ...
      aboriginal: {
        ...
        'Deep Orange': {
          ...
          'brand-supplementary': { label: 'Deep Orange', value: '#882600' },
          'brand-accent': { label: 'Saltwater Blue', value: '#0D6791' },
          'brand-accent-light': { label: 'Coastal Blue', value: '#C1E2E8' },
        ...
        'Bush Honey Yellow': {
          ...
          'brand-supplementary': { label: 'Bush Honey Yellow', value: '#895E00' },
        ...
        'Bushland Green': {
          ...
          'brand-supplementary': { label: 'Bushland Green', value: '#215834' },
