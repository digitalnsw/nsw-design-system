    ...
    palettes: {
      default: {
        ...
        'Orange 01': {
          ...
          'brand-supplementary': { label: 'Purple 02', value: '#8055F1' },
          'brand-accent': { label: 'Orange 02', value: '#F3631B' },
          'brand-accent-light': { label: 'Orange 03', value: '#FFCE99' },
        ...
        'Yellow 01': {
          ...
          'brand-supplementary': { label: 'Blue 02', value: '#146CFD' },
          'brand-accent': { label: 'Yellow 02', value: '#FAAF05' },
          'brand-accent-light': { label: 'Yellow 03', value: '#FDE79A' },
        ...
        'Green 01': {
          ...
          'brand-accent-light': { label: 'Green 03', value: '#A8EDB3' },
      ...
      aboriginal: {
        ...
        'Deep Orange': {
          ...
          'brand-accent-light': { label: 'Clay Orange', value: '#F4AA7D' },
        ...
        'Bush Honey Yellow': {
          ...
          'brand-accent-light': { label: 'Golden Wattle Yellow', value: '#FEE48C' },
        ...
        'Bushland Green': {
          ...
          'brand-supplementary': { label: 'Firewood Brown', value: '#9E5332' },
          'brand-accent': { label: 'Marshland Lime', value: '#78A146' },
          'brand-accent-light': { label: 'Gumleaf Green', value: '#B5CDA4' },
