...
const data = [
  {
    ...
    keywords: 'ask questions, problems, solutions, share, report a bug, collaborate, learn',
    url: 'https://community.digital.nsw.gov.au',
  },
  {
    objectID: '2',
  ...
  {
    objectID: '3',
    title: 'Supporting different roles',
  ...
  },
  {
    ...
    keywords: 'Background colour, Text colour, Border colour, Font size, Border size, Box shadow, Viewport visibility, Hide, Show',
    url: '/docs/content/develop/helpers.html',
  },
  {
    objectID: '14',
    title: 'Logo',
  ...
  {
    objectID: '57',
    title: 'Public Sans download',
    keywords: 'Installing, font, typography',
