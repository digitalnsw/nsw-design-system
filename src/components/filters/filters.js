...
class Filters {
  constructor(element) {
    ...
    this.controlsButtonText = this.controlsButton && this.controlsButton.querySelector('span:not(.nsw-material-symbols):not(.nsw-material-symbols)')
  ...
  setSelectedState() {
    ...
    const checkIcon = '<span class="material-symbols-outlined nsw-material-symbols nsw-material-symbols--valid" focusable="false" aria-hidden="true">check_circle</span>'
