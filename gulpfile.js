...
function renamePath() {
  return src(`${config.dir.build}index.html`)
    ...
    .pipe(replace('/favicon-96x96.png', './favicon-96x96.png'))
    .pipe(replace('/favicon-dark-96x96.png', './favicon-dark-96x96.png'))
    .pipe(replace('/favicon.svg', './favicon.svg'))
    .pipe(replace('/favicon-dark.svg', './favicon-dark.svg'))
